...
#   add_battle_drop($data_items[$game_variables[X]]) per le variabili
#
# ● BattleManager.process_victory
#   per terminare istantaneamente la battaglia in corso con una vittoria.
#===============================================================================
...
class Game_Troop < Game_Unit
  ...
  #--------------------------------------------------------------------------
  def gold_total; h87_d_gold_total + @extra_gold; end
  #--------------------------------------------------------------------------
  # * Gets the total exp plus extra
  #--------------------------------------------------------------------------
  def exp_total; h87_d_exp_total + @extra_exp; end
end
