...
module YEA
  module SHOP
    ...
    # :command => ["Display Name", EnableSwitch, ShowSwitch, Handler Method],
      :equip   => [       "Equipaggia",            0,          0, :command_equip],
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    STATUS_FONT_SIZE = 12       # Font size used for data window.
    ...
    VOCAB_STATUS ={
      ...
      :hp_recover => "Recupero HP",      # Text used for HP Recovery.
      :mp_recover => "Recupero MP",      # Text used for MP Recovery.
      :tp_recover => "Recupero TP",      # Text used for TP Recovery.
      :tp_gain    => "Aumento TP",      # Text used for TP Gain.
      :applies    => "Applica",      # Text used for applied states and buffs.
      :removes    => "Rimuove",      # Text used for removed states and buffs.
    } # Do not remove this.
