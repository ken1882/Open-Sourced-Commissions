...
module YEA
  module BATTLE
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    BATTLESTATUS_NAME_FONT_SIZE = 11    # Font size used for name.
    BATTLESTATUS_TEXT_FONT_SIZE = 12    # Font size used for HP, MP, TP.
    BATTLESTATUS_NO_ACTION_ICON = 1931  # No action icon.
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    HELP_TEXT_ALL_FOES        = "Tutti i Nemici"
    HELP_TEXT_ONE_RANDOM_FOE  = "Un Nemico Casuale"
    HELP_TEXT_MANY_RANDOM_FOE = "%d Nemici a Casaccio"
    HELP_TEXT_ALL_ALLIES      = "Tutti gli Alleati"
    HELP_TEXT_ALL_DEAD_ALLIES = "Tutti gli Alleati Morti"
    HELP_TEXT_ONE_RANDOM_ALLY = "Un Alleato Casuale"
    HELP_TEXT_RANDOM_ALLIES   = "%d Alleati a Casaccio"
    ...
    POPUP_SETTINGS ={
      ...
      :drained    => "RISUCCHIO",     # Text display for draining HP/MP.
      :critical   => "CRITICO!",  # Text display for critical hit.
      :missed     => "MANCATO",   # Text display for missed attack.
      :evaded     => "SCHIVATO",  # Text display for evaded attack.
      :nulled     => "NULLO",    # Text display for nulled attack.
      :failed     => "FALLITO",   # Text display for a failed attack.
      ...
      :weakpoint  => "È SUPEREFFICACE!", # Appears if foe is weak to element.
      :resistant  => "NON È MOLTO EFFICACE...",    # Appears if foe is resistant to element.
      :immune     => "IMMUNE",    # Appears if foe is immune to element.
      :absorbed   => "ASSORBITO", # Appears if foe can absorb the element.
    ...
    DEFAULT = ["Friz Quadrata TT", "VL Gothic", "Verdana", "Arial", "Courier"]
